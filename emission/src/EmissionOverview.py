...
class EmissionOverview(Screen, HelpableScreen):
	skin = """<screen name="EmissionOverview" title="Torrent Overview" position="75,135" size="565,330">
		...
		<widget size="320,25" alphaTest="on" position="5,45" zPosition="1" name="all_sel" pixmap="epg_now.png" />
		<widget verticalAlignment="center" transparent="1" size="108,22" backgroundColor="#25062748" position="5,47" zPosition="2" source="all_text" render="Label" horizontalAlignment="center" font="Regular;18" />
		<widget size="320,25" alphaTest="on" position="5,45" zPosition="1" name="downloading_sel" pixmap="epg_next.png" />
		<widget verticalAlignment="center" transparent="1" size="108,22" backgroundColor="#25062748" position="111,47" zPosition="2" source="downloading_text" render="Label" horizontalAlignment="center" font="Regular;18" />
		<widget size="320,25" alphaTest="on" position="5,45" zPosition="1" name="seeding_sel" pixmap="epg_more.png" />
		<widget verticalAlignment="center" transparent="1" size="108,22" backgroundColor="#25062748" position="212,47" zPosition="2" source="seeding_text" render="Label" horizontalAlignment="center" font="Regular;18" />
		<widget source="torrents" render="Label" size="240,22" position="320,47" horizontalAlignment="right" font="Regular;18" />
		<!--ePixmap size="550,230" alphaTest="on" position="5,65" pixmap="border_epg.png" /-->
		...
		<widget source="upspeed" render="Label" size="150,20" position="5,300" horizontalAlignment="left" font="Regular;18" />
		<widget source="downspeed" render="Label" size="150,20" position="410,300" horizontalAlignment="right" font="Regular;18" />
	</screen>"""
