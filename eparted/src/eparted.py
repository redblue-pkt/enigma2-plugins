...
class AddPart(Screen, ConfigListScreen):
	skin = """<screen name="AddPart" position="center,center" size="600,190" title="add Partition" >
			...
			<widget render="Label" source="key_red" position="5,5" size="140,40" zPosition="2" verticalAlignment="center" horizontalAlignment="center" backgroundColor="red" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" />
			<widget render="Label" source="key_green" position="155,5" size="140,40" zPosition="2" verticalAlignment="center" horizontalAlignment="center" backgroundColor="red" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" />
...
class Cpart(Screen):
	...
	skin = """<screen position="center,center" size="670,200" title="eParted">
			...
			<widget name="LabelRed" position="50,160" size="150,40" font="Regular;19" verticalAlignment="center" />
			...
			<widget name="LabelGreen" position="250,160" size="150,40" font="Regular;19" verticalAlignment="center" />
			...
			<widget name="LabelBlue" position="450,160" size="150,40" font="Regular;19" verticalAlignment="center" />
		</screen>"""
...
class Cpartexe(Screen):
	skin = """<screen position="center,center" size="670,400" title=" ">
			...
			<widget name="LabelButton" position="50,360" size="620,40" font="Regular;19" verticalAlignment="center" />
		</screen>"""
