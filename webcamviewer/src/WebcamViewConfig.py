...
class WebcamViewerMenu(ConfigListScreen, Screen):
	skin = """
		...
		<widget name="key_red" position="10,360" size="100,40" backgroundColor="red" verticalAlignment="center" horizontalAlignment="center" zPosition="2"  foregroundColor="white" font="Regular;18"/>
		<widget name="key_green" position="120,360" size="100,40" backgroundColor="green" verticalAlignment="center" horizontalAlignment="center" zPosition="2"  foregroundColor="white" font="Regular;18"/>
		</screen>"""
