...
class AutoTimerWizard(WizardLanguage, AutoTimerEditorBase, ShowRemoteControl):
	...
	skin = """
		<screen name="AutoTimerWizard" position="0,0" size="720,576" title="Welcome..." flags="wfNoBorder" >
			...
			<widget name="rc" pixmaps="rc0.png,rc1.png,rc2.png" position="500,50" zPosition="10" size="154,500" alphatest="on" />
			...
			<widget name="HelpWindow" pixmap="buttons/key_text.png" position="310,435" zPosition="1" size="1,1" transparent="1" alphatest="on" />
		</screen>"""
