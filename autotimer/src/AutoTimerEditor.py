...
class AutoTimerEditor(Screen, ConfigListScreen, AutoTimerEditorBase):
	...
	if HD:
		skin = """<screen name="AutoTimerEditor" title="Edit AutoTimer" position="center,center" size="700,572">
			...
			<widget source="key_red" render="Label" position="40,5" zPosition="1" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;18" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
			<widget source="key_green" render="Label" position="200,5" zPosition="1" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;18" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
			<widget source="key_yellow" render="Label" position="360,5" zPosition="1" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;18" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
			<widget source="key_blue" render="Label" position="520,5" zPosition="1" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;18" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
