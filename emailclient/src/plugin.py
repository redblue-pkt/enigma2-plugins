...
class ScreenMailView(Screen):
	...
	def __init__(self, session, account, message, uid, flags):
		...
		<screen position="%d,%d" size="%d,%d" title="view Email" >
			...
			<ePixmap position="%d,%d" zPosition="4" size="140,40" pixmap="buttons/yellow.png" transparent="1" alphaTest="on" />
			<ePixmap position="%d,%d" zPosition="4" size="140,40" pixmap="buttons/blue.png" transparent="1" alphaTest="on" />
			...
			<widget name="buttonyellow" position="%d,%d" zPosition="5" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;%d" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
...
class EmailAccountList(Screen):
	...
	def __init__(self, session):
		...
		self.skin = """
			...
			<ePixmap position="%d,%d" zPosition="4" size="140,40" pixmap="buttons/green.png" transparent="1" alphaTest="on" />
			<ePixmap position="%d,%d" zPosition="4" size="140,40" pixmap="buttons/yellow.png" transparent="1" alphaTest="on" />
			<ePixmap position="%d,%d" 	size="35,25" pixmap="buttons/key_menu.png" 	alphaTest="on" />
			<widget name="buttonred" position="%d,%d" zPosition="5" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;%d" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
			<widget name="buttongreen" position="%d,%d" zPosition="5" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;%d" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
			<widget name="buttonyellow" position="%d,%d" zPosition="5" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;%d" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
			</screen>""" % (
