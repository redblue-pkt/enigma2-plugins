...
if os.name == "nt" or os.name == "dos" or os.name == "os2" or os.name == "ce":
	...
	#CDLL("/usr/lib/enigma2/python/Plugins/Extensions/SubsDownloader2/libs/libzen.so.0.0.0")
	#MediaInfoDLL_Handler = CDLL("/usr/lib/enigma2/python/Plugins/Extensions/SubsDownloader2/libs/libmediainfo.so.0.0.0")
