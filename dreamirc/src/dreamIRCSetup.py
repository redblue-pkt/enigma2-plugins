...
class dreamIRCSetupScreen(ConfigListScreen, Screen):
	...
	if (y >= 720):
		skin = """
			...
			<ePixmap pixmap="div-h.png" position="10,245" size="480,2" transparent="1" alphaTest="on" />
			<ePixmap pixmap="buttons/red.png" position="60,250" size="160,40" alphaTest="on" />
			<ePixmap pixmap="buttons/green.png" position="280,250" size="160,40" alphaTest="on" />
			<widget source="key_red" render="Label" position="60,250" zPosition="1" size="150,40" font="Regular;19" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#9f1313" transparent="1" />
			<widget source="key_green" render="Label" position="280,250" zPosition="1" size="150,40" font="Regular;19" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#1f771f" transparent="1" />
		</screen>"""
	else:
		skin = """
