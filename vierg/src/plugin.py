	...
	def __init__(self, session):
		...
		vierg.skin = """
			<screen position="center,center" size="378,440" title="Vier Gewinnt %s" >
				...
				<widget name="message" position="0,360" size="378,30" zPosition="3" backgroundColor="#062748" verticalAlignment="center" horizontalAlignment="center" font="Regular;26"/>
				...
				<widget name="key_red"   position=" 10,390" zPosition="4" size="140,40" verticalAlignment="center" horizontalAlignment="center" font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
				<widget name="key_green" position="228,390" zPosition="4" size="140,40" verticalAlignment="center" horizontalAlignment="center"  font="Regular;21" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" />
