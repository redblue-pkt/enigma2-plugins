...
class LastFMScreenMain(Screen, HelpableScreen, LastFM):
    skin = """
        <screen name="LastFM" position="center,center" size="600,440" title="%s" >
            ...
            <widget name="artist" position="0,5" size="100,30" verticalAlignment=\"center\" horizontalAlignment=\"left\" zPosition=\"2\"  foregroundColor=\"white\" font=\"Regular;18\" />
            <widget name="album" position="0,45" size="100,30" verticalAlignment=\"center\" horizontalAlignment=\"left\" zPosition=\"2\"  foregroundColor=\"white\" font=\"Regular;18\" />
            <widget name="track" position="0,85" size="100,30" verticalAlignment=\"center\" horizontalAlignment=\"left\" zPosition=\"2\"  foregroundColor=\"white\" font=\"Regular;18\" />

            <widget name="info_artist" position="105,5" size="300,30" verticalAlignment=\"center\" horizontalAlignment=\"left\" zPosition=\"2\"  foregroundColor=\"white\" font=\"Regular;18\" />
            <widget name="duration" position="420,5" size="60,30" verticalAlignment=\"center\" horizontalAlignment=\"right\" zPosition=\"2\"  foregroundColor=\"white\" font=\"Regular;18\" />
            <widget name="info_album" position="105,45" size="370,30" verticalAlignment=\"center\" horizontalAlignment=\"left\" zPosition=\"2\"  foregroundColor=\"white\" font=\"Regular;18\" />
            <widget name="info_track" position="105,85" size="370,30" verticalAlignment=\"center\" horizontalAlignment=\"left\" zPosition=\"2\"  foregroundColor=\"white\" font=\"Regular;18\" />
            ...
            <widget name="button_red" position="0,360" size="140,40" verticalAlignment=\"center\" horizontalAlignment=\"center\" zPosition=\"3\" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" font=\"Regular;18\" />
            <widget name="button_green" position="140,360" size="140,40" verticalAlignment=\"center\" horizontalAlignment=\"center\" zPosition=\"3\" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" font=\"Regular;18\"/>
            <widget name="button_yellow" position="280,360" size="140,40" verticalAlignment=\"center\" horizontalAlignment=\"center\" zPosition=\"3\" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" font=\"Regular;18\" />
            <widget name="button_blue" position="420,360" size="140,40" verticalAlignment=\"center\" horizontalAlignment=\"center\" zPosition=\"3\" transparent="1" foregroundColor="white" shadowColor="black" shadowOffset="-1,-1" font=\"Regular;18\" />
            ...
            <widget name="infolabel" position="10,410" size="500,20" verticalAlignment=\"center\" horizontalAlignment=\"left\" zPosition=\"2\"  foregroundColor=\"white\" font=\"Regular;16\" />
...
class lastfmLCDScreen(Screen):
	...
	<screen name="LastFM_Summary" position="0,0" size="132,64" id="1">
		<widget name="text1" position="2,0" size="128,25" font="Regular;12" horizontalAlignment="center" verticalAlignment="center"/>
		<widget name="text2" position="2,29" size="128,35" font="Regular;10" horizontalAlignment="center" verticalAlignment="center"/>
	</screen>"""
