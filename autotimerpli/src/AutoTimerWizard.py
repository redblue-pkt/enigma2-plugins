...
class AutoTimerWizard(WizardLanguage, AutoTimerEditorBase, ShowRemoteControl):
	...
	skin = """
		<screen name="AutoTimerWizard" position="center,center" size="720,576" title="Welcome..." flags="wfNoBorder" >
			...
			<widget source="VKeyIcon" render="Pixmap" pixmap="buttons/key_text.png" position="35,270" zPosition="0" size="35,25" transparent="1" alphatest="on" >
				<convert type="ConditionalShowHide" />
			</widget>
			<widget name="HelpWindow" pixmap="buttons/key_text.png" position="200,450" zPosition="1" size="1,1" transparent="1" alphatest="on" />
		</screen>"""
