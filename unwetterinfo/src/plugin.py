...
class UnwetterMain(Screen):
	skin = """
		<screen position="center,center" size="530,430" title="Unwetterzentrale" >
			...
			<ePixmap position="10,360" zPosition="2" size="45,44" pixmap="buttons/key_menu.png" alphaTest="on" />
			<widget name="statuslabel" position="5,410" zPosition="2" size="530,20" font="Regular;16" horizontalAlignment="left"/>
		</screen>"""
