...
def Partnerbox_EPGList__init__(self, type=0, selChangedCB=None, timer=None, time_epoch=120, overjump_empty=False, graphic=False):
    ...
    self.clocks = [LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_add.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_pre.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_prepost.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_post.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_add.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_pre.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_zap.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_prepost.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_post.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_add.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_pre.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_zaprec.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_prepost.png'),
                   LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_post.png')]

    self.selclocks = [LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_add.png'),
                      LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_selpre.png'),
                      LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock.png'),
                      LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_selprepost.png'),
                      LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_selpost.png'),
                      LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_add.png'),
                      LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_selpre.png'),
                      LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_zap.png'),
                      LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_selprepost.png'),
    ...
    self.autotimericon = LoadPixmap(cached=True, path=SKINDEFAULT + 'icons/epgclock_autotimer.png')
    ...
    if clock_types:
        if self.wasEntryAutoTimer and clock_types in (2, 7, 12):
            res.extend((
                ...
                (eListboxPythonMultiContent.TYPE_TEXT, r3.x, r3.y, r3.w - self.picx * 2 - (self.gap * 2) - self.posx,
                 r3.h, 0, RT_HALIGN_LEFT | RT_VALIGN_CENTER, EventName, foreColor, foreColorSel, backColor, backColorSel)
            ))
        else:
            res.extend((
                (eListboxPythonMultiContent.TYPE_PIXMAP_ALPHABLEND, r3.x + r3.w - self.picx - self.posx, (r3.h / 2 - self.posy), self.picx, self.picy, self.clocks[clock_types]),
