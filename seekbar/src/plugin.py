...
class Seekbar(ConfigListScreen, Screen):
	...
	<screen position="center,center" size="560,160" title="%s">
		...
		<widget name="time" position="50,130" size="100,20" font="Regular;20" horizontalAlignment="left" backgroundColor="#4e5a74" transparent="1" />
		<widget source="session.CurrentService" render="Label" position="420,130" size="90,24" font="Regular;20" horizontalAlignment="right" backgroundColor="#4e5a74" transparent="1">
