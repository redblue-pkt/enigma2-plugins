...
class CurlyTxSettings(ConfigListScreen, HelpableScreen, Screen):
	...
	<screen name="Setup" position="center,center" size="560,430" title="Settings">
	  ...
	  <widget source="key_yellow" render="Label" position="280,0" zPosition="1" size="140,40" font="Regular;20" verticalAlignment="center" horizontalAlignment="center" backgroundColor="#a08500" transparent="1" />
	  <widget source="key_blue"   render="Label" position="420,0" zPosition="1" size="140,40" font="Regular;20" verticalAlignment="center" horizontalAlignment="center" backgroundColor="#18188b" transparent="1" />
