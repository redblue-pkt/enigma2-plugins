	...
	def __init__(self, session, args=None):
		...
		self.skin = """
			<screen position="center,center" size="500,210" title="VFD Display Setup" >
				...
				<ePixmap position="40,165" size="140,40" pixmap="buttons/red.png" alphatest="on" />
				<ePixmap position="180,165" size="140,40" pixmap="buttons/green.png" alphatest="on" />
				<ePixmap position="360,165" size="140,40" pixmap="buttons/yellow.png" alphatest="on" />
