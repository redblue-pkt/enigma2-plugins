...
class AspectRatioSwitchSetup(ConfigListScreen, Screen):
	skin = """
		<screen position="center,center" size="550,500" title="AspectRatioSwitch Setup">
			...
			<widget name="label" position="10,355" size="530,100" font="Regular;18" horizontalAlignment="left"  />
			<ePixmap pixmap="buttons/red.png" position="10,460" size="140,40" transparent="1" alphaTest="on" />
			<widget render="Label" source="key_red" position="10,460" size="140,40" transparent="1" horizontalAlignment="center" verticalAlignment="center" zPosition="2" foregroundColor="white" font="Regular;18" />
			<ePixmap pixmap="buttons/green.png" position="180,460" size="140,40" transparent="1" alphaTest="on" />
			<widget render="Label" source="key_green" position="180,460" size="140,40" transparent="1" horizontalAlignment="center" verticalAlignment="center" zPosition="2" foregroundColor="white" font="Regular;18" />
 		</screen>"""
