...
SKIN = """
    <screen flags="wfNoBorder" position="0,0" size="82,104" title="Kiddy Timer" backgroundColor="#ff000000">
        ...
        <widget name="TimerSliderText" zPosition="5" position="0,83" size="82,21" font="Regular;18" horizontalAlignment="center" verticalAlignment="center" foregroundColor="#000000" backgroundColor="#aaffffff" />
        ...
        <widget name="TimerText" zPosition="3" position="0,30" size="82,21" font="Regular;18" horizontalAlignment="center" verticalAlignment="center" foregroundColor="#000000" transparent = "1" />
        <widget name="TimerTransparent" pixmap="~/img/Transparent.png" zPosition="2" position="0,0" size="82,82" transparent="1" alphaTest="off" />
        <widget name="TimerTransparentText" zPosition="3" position="0,30" size="82,21" font="Regular;18" horizontalAlignment="center" verticalAlignment="center" foregroundColor="#000000" backgroundColor="#aaffffff" />
    </screen>"""
