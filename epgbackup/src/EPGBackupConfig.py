...
class EPGBackupConfig(Screen, HelpableScreen, ConfigListScreen):
	skin = """
		<screen name="EPGBackupSetup" position="center,center" size="700,520" >
			...
			<widget  position="0,0" size="140,40" source="key_red" render="Label" transparent="1" horizontalAlignment="center" verticalAlignment="center" zPosition="2" foregroundColor="white" font="Regular;18" />
			<ePixmap position="140,0" size="140,40" pixmap="buttons/green.png" transparent="1" alphaTest="on" />
			<widget  position="140,0" size="140,40" render="Label" source="key_green" transparent="1" horizontalAlignment="center" verticalAlignment="center" zPosition="2" foregroundColor="white" font="Regular;18" />
