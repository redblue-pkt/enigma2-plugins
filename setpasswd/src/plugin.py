...
class ChangePasswdScreen(Screen):
	skin = """
		...
		<widget source="key_red" render="Label" position="5,210" zPosition="1" size="140,40" font="Regular;17" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#9f1313" transparent="1" />
		<widget source="key_green" render="Label" position="150,210" zPosition="1" size="140,40" font="Regular;17" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#1f771f" transparent="1" />
		<widget source="key_yellow" render="Label" position="295,210" zPosition="1" size="140,40" font="Regular;17" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#1f771f" transparent="1" />
		<widget source="key_blue" render="Label" position="440,210" zPosition="1" size="140,40" font="Regular;17" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#1f771f" transparent="1" />
	</screen>""" % title
