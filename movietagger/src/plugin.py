...
class MovieTagger(Screen):
	skin = """
		<screen position="center,70" size="600,460" title="Movie Tagger" >
			<widget name="moviename" position="10,0" size="580,60" verticalAlignment="top" font="Regular;25"/>
			<ePixmap pixmap="div-h.png" position="0,62" zPosition="1" size="600,2" />
			<widget name="assignedTags" position="10,65" size="260,30" verticalAlignment="top" horizontalAlignment="left" zPosition="2" foregroundColor="white" font="Regular;23"/>
			<widget name="cTaglist" position="10,100" size="260,250" scrollbarMode="showOnDemand"/>
			<widget name="definedTags" position="300,65" size="290,30" verticalAlignment="top" horizontalAlignment="left" zPosition="2" foregroundColor="white" font="Regular;23"/>
			...
			<widget name="usedTag" position="10,365" size="185,50" verticalAlignment="top" horizontalAlignment="center" zPosition="2" foregroundColor="#ffff00" font="Regular;21"/>
			<widget name="userTag" position="200,365" size="185,50" verticalAlignment="top" horizontalAlignment="center" zPosition="2" foregroundColor="#ff0000" font="Regular;21"/>
			<widget name="preTag" position="400,365" size="190,50" verticalAlignment="top" horizontalAlignment="center" zPosition="2" foregroundColor="#00ff00" font="Regular;21"/>
			...
			<widget name="buttonred" position="0,420" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="2" foregroundColor="white" transparent="1" font="Regular;18"/>
			<widget name="buttongreen" position="155,420" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="2" foregroundColor="white" transparent="1" font="Regular;18"/>
			<widget name="buttonyellow" position="305,420" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="2" foregroundColor="white" transparent="1" font="Regular;18"/>
			<widget name="buttonblue" position="455,420" size="140,40" verticalAlignment="center" horizontalAlignment="center" zPosition="2" foregroundColor="white" transparent="1" font="Regular;18"/>
		</screen>"""
