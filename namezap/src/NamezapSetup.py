...
class NamezapSetup(Screen, ConfigListScreen):
	skin = """<screen name="NamezapSetup" position="center,center" size="565,370">
	...
	def __init__(self, session):
		...
		# Summary
		self.setup_title = _("NameZAP Setup")
		self.onChangedEntry = []
