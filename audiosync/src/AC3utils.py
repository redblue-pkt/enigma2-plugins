...
SKIN = """
        <screen flags="wfNoBorder" position="30,30" size="600,460" title="Audio Sync" zPosition="1" backgroundColor="#ff000000">
            ...
            <widget name="ChannelLabel" zPosition="2" position="33,40" size="130,20" font="Regular;14" horizontalAlignment="center" verticalAlignment="center" transparent="1" backgroundColor="#232323" foregroundColors="#ffffff,#fe6b1b"/>
            ...
            <widget name="GlobalLabel" zPosition="2" position="178,40" size="110,20" font="Regular;14" horizontalAlignment="center" verticalAlignment="center" transparent="1" backgroundColor="#232323" foregroundColors="#ffffff,#fe6b1b"/>
            ...
            <widget name="AudioSlider" zPosition="4" position="5,245" size="70,20" font="Regular;14" horizontalAlignment="center" verticalAlignment="center" backgroundColor="#232323" foregroundColor="#eeeeee" transparent="1"/>
            ...
            <widget name="key_green" position="315,15" zPosition="4" size="85,20"
                font="Regular;14" verticalAlignment="center" horizontalAlignment="left" backgroundColor="#232323" foregroundColor="#ffffff" transparent="1"/>
