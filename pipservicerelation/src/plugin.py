...
class PipServiceRelationSetup(Screen):
	skin = """
		<screen position="center,center" size="655,400">
			<widget render="Label" source="name" position="5,0" size="320,50" font="Regular;20" horizontalAlignment="left"/>
			<widget render="Label" source="relationname" position="330,0" size="320,50" font="Regular;20" horizontalAlignment="left"/>
